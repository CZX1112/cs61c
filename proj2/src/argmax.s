...
loop_continue:
    bge t0, a1, loop_end    # if t0 >= a1, go to loop_end
    ...
    addi t1, t5, 0          # else: t1 = t5, change the largest num
    addi t2, t0, 0          # t2 = t0, change the index of largest num

loop_goback:
    addi t0, t0, 1          # increment of i
    j loop_continue

loop_end:
    # Epilogue
    addi a0, t2, 0          # put the index of largest num from t2 to a0
    lw ra, 0(sp)
    addi sp, sp, 4
    ret
